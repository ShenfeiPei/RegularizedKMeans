...
namespace cf{
    ...
    template <typename T>
    void symmetry(vector<vector<int>> &NN, vector<vector<T>> &NND, int argument){
        int N = NN.size();
        int knn = NN[0].size();
    ...
    template void symmetry<int>(vector<vector<int>> &NN, vector<vector<int>> &NND, int argument);
    template void symmetry<double>(vector<vector<int>> &NN, vector<vector<double>> &NND, int argument);
